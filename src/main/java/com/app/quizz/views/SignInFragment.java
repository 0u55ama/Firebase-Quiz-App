...
public class SignInFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        editEmail = view.findViewById(R.id.signInEmail);
        editPass = view.findViewById(R.id.signInPass);
        signUptext = view.findViewById(R.id.signIntextView);
        ...
        signInBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!email.isEmpty() && !pass.isEmpty()){
                    ...
                    Toast.makeText(getContext(),"your login operation is successful",Toast.LENGTH_LONG).show();
