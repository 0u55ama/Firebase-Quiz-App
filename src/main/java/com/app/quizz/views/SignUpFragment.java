...
public class SignUpFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        editEmail = view.findViewById(R.id.signUpEmail);
        editPass = view.findViewById(R.id.signUpPass);
        signIntext = view.findViewById(R.id.signUptextView);
        ...
        signUpBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!email.isEmpty() && !pass.isEmpty()){
                    ...
                    Toast.makeText(getContext(),"your register operation is successful",Toast.LENGTH_LONG).show();
